...
IGCUserPeer {
    ...
    static {
        Runtime.register("c.gls, OBDLink, Version=4.2.1.0, Culture=neutral, PublicKeyToken=null", gls.class, __md_methods);
    }

    public gls() throws Throwable {
        if (this.getClass() == gls.class) {
            TypeManager.Activate("c.gls, OBDLink, Version=4.2.1.0, Culture=neutral, PublicKeyToken=null", "", this, new Object[0]);
        }
    }
