...
IGCUserPeer {
    ...
    public EffectUpdateListenerImplementor() throws Throwable {
        if (this.getClass() == EffectUpdateListenerImplementor.class) {
    ...
    private native void n_onEffectUpdated(Effect var1, Object var2);
    ...
    public void onEffectUpdated(Effect effect, Object object) {
        super.n_onEffectUpdated(effect, object);
    }
}
