...
implements IGCUserPeer {
    ...
    static {
        Runtime.register("H.tcf, OBDLink, Version=4.2.1.0, Culture=neutral, PublicKeyToken=null", tcf.class, __md_methods);
    }

    public tcf() throws Throwable {
        if (this.getClass() == tcf.class) {
            TypeManager.Activate("H.tcf, OBDLink, Version=4.2.1.0, Culture=neutral, PublicKeyToken=null", "", this, new Object[0]);
        }
    }
